 ...
 */
public class SQLAlterTableOptimizePartitionAction extends AbstractSQLExpr implements ISQLAlterTableAction {
    ...
    @Override
    public SQLAlterTableOptimizePartitionAction clone() {
        SQLAlterTableOptimizePartitionAction x = new SQLAlterTableOptimizePartitionAction();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLAlterTableOptimizePartitionAction x) {
        super.cloneTo(x);
