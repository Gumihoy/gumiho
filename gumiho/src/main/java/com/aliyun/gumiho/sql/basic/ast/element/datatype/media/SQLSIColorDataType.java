 ...
 */
public class SQLSIColorDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLSIColorDataType() {
        super(SQLReserved.SI_Color.ofExpr());
    }

    public SQLSIColorDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.SI_Color.ofExpr());
    }
    ...
    @Override
    public SQLSIColorDataType clone() {
        return new SQLSIColorDataType();
    }
}
