 ...
 */
public class PostgreSQLSQLASTBuilderVisitor extends PPASSQLStatementParserBaseVisitor<SQLObject> {


    private List<SQLObject> sqlObjects;

    public PostgreSQLSQLASTBuilderVisitor() {
    }

    public PostgreSQLSQLASTBuilderVisitor(List<SQLObject> sqlObjects) {
