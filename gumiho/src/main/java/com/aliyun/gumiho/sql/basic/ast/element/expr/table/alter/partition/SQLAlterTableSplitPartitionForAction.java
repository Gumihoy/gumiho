 ...
 */
public class SQLAlterTableSplitPartitionForAction extends AbstractSQLAlterTableSplitPartitionAction {
    ...
    @Override
    public SQLAlterTableSplitPartitionForAction clone() {
        SQLAlterTableSplitPartitionForAction x = new SQLAlterTableSplitPartitionForAction();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLAlterTableSplitPartitionForAction x) {
        super.cloneTo(x);
