 ...
 */
public class PPASSQLASTVisitorAdapter extends OracleSQLASTVisitorAdapter implements PPASSQLASTVisitor {

    public PPASSQLASTVisitorAdapter() {
    }

    public PPASSQLASTVisitorAdapter(SQLTransformConfig config) {
        super(config);
    }
