 ...
 */
public class OracleSQLIsOpenNameCursorExpr extends AbstractOracleSQLNameCursorExpr implements IOracleSQLImplicitCursorExpr {
    ...
    @Override
    public OracleSQLIsOpenNameCursorExpr clone() {
