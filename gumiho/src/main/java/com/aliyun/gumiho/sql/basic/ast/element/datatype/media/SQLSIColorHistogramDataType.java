 ...
 */
public class SQLSIColorHistogramDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLSIColorHistogramDataType() {
        super(SQLReserved.SI_ColorHistogram.ofExpr());
    }

    public SQLSIColorHistogramDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.SI_ColorHistogram.ofExpr());
    }
