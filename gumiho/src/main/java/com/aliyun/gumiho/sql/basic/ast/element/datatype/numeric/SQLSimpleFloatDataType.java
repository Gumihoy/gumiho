 ...
 */
public class SQLSimpleFloatDataType extends AbstractSQLNumericDataType {

    public SQLSimpleFloatDataType() {
        super(SQLReserved.SIMPLE_FLOAT.ofExpr());
    }
    ...
    @Override
    public SQLSimpleFloatDataType clone() {
        SQLSimpleFloatDataType x = new SQLSimpleFloatDataType();
        x.name = this.name;
        return x;
    }
}
