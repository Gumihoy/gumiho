 ...
 */
public class OracleSQLFoundImplicitCursorExpr extends AbstractOracleSQLExpr implements IOracleSQLImplicitCursorExpr {
    ...
    @Override
    public OracleSQLFoundImplicitCursorExpr clone() {
        OracleSQLFoundImplicitCursorExpr x = new OracleSQLFoundImplicitCursorExpr();
        return x;
    }
}
