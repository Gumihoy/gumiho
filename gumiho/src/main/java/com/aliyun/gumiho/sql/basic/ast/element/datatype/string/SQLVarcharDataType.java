 ...
 */
public class SQLVarcharDataType extends AbstractSQLTextDataType {

    public SQLVarcharDataType() {
        super(SQLReserved.VARCHAR.ofExpr());
    }

    public static SQLVarcharDataType of() {
        return new SQLVarcharDataType();
    }
