 ...
 */
package com.aliyun.gumiho.sql.basic.ast.element.datatype.record;
 ...
 */
public class SQLRecordDataType extends AbstractSQLDataType {


    public SQLRecordDataType() {
        super(SQLReserved.RECORD.ofExpr());
    }
