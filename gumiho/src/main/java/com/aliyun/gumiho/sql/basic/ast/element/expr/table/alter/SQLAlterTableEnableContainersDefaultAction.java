 ...
 */
public class SQLAlterTableEnableContainersDefaultAction extends AbstractSQLExpr implements ISQLAlterTableAction {
    ...
    @Override
    public SQLAlterTableEnableContainersDefaultAction clone() {
