...
/**
 * https://ronsavage.github.io/SQL/sql-2003-2.bnf.html#table%20constraint
 *
 * @author kongtong.ouyang onCondition 2018/3/13.
 */
public interface ISQLTableConstraint extends SQLConstraint, SQLTableElement {

    @Override
    ISQLTableConstraint clone();
}
