 ...
 */
public class SQLCommentOnEditionStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnEditionStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnEditionStatement clone() {
        SQLCommentOnEditionStatement x = new SQLCommentOnEditionStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
