 ...
 */
public class OracleSQLMaxSizeClause extends AbstractOracleSQLExpr implements OracleSQLStorageClause.OracleSQLStorageClauseItem {
    ...
    @Override
    public OracleSQLMaxSizeClause clone() {
