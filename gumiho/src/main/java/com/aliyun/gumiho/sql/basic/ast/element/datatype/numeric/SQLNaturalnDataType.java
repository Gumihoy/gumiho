 ...
 */
public class SQLNaturalnDataType extends AbstractSQLNumericDataType implements ISQLPlsIntegerDataType {

    public SQLNaturalnDataType() {
        super(SQLReserved.NATURALN.ofExpr());
    }
    ...
    @Override
    public SQLNaturalnDataType clone() {
        SQLNaturalnDataType x = new SQLNaturalnDataType();
        x.name = this.name;
        return x;
    }
}
