 ...
 */
public class OracleSQLUserSysClause extends AbstractOracleSQLExpr {

    public SQLIdentifier password;

    public OracleSQLUserSysClause(SQLIdentifier password) {
    ...
    @Override
    public OracleSQLUserSysClause clone() {
        OracleSQLUserSysClause x = new OracleSQLUserSysClause(this.password);
        return x;
    }

    public void cloneTo(OracleSQLUserSysClause x) {
    }
