 ...
 */
public class SQLSIStillImageDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLSIStillImageDataType() {
        super(SQLReserved.SI_StillImage.ofExpr());
    }

    public SQLSIStillImageDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.SI_StillImage.ofExpr());
    }
