 ...
 */
public class SQLAlterViewReadOnlyAction extends AbstractSQLExpr implements ISQLAlterViewAction {
    ...
    @Override
    public SQLAlterViewReadOnlyAction clone() {
        SQLAlterViewReadOnlyAction x = new SQLAlterViewReadOnlyAction();
        return x;
    }
