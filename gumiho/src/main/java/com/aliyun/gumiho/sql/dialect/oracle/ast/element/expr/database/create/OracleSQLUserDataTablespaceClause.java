 ...
 *
 * @author kongtong.ouyang onCondition 2018/3/17.
 */
public class OracleSQLUserDataTablespaceClause extends AbstractOracleSQLExpr {

    public OracleSQLFileType type;

    public SQLIdentifier name;

    public List<OracleSQLDataFileTempFileSpec> dataFileTempFileSpecs = new ArrayList<>();
    ...
    public void accept0(OracleSQLASTVisitor visitor) {
        if (visitor.visit(this)) {
            ...
            this.acceptChild(visitor, dataFileTempFileSpecs);
        }
    }
}
