 ...
 */
public class SQLAlterViewCompileAction extends AbstractSQLExpr implements ISQLAlterViewAction {
    ...
    @Override
    public SQLAlterViewCompileAction clone() {
        SQLAlterViewCompileAction x = new SQLAlterViewCompileAction();
        return x;
    }
