 ...
 */
public class SQLURowIdDataType extends AbstractSQLTextDataType {

    public SQLURowIdDataType() {
        super(SQLReserved.UROWID.ofExpr());
    }

    public SQLURowIdDataType(int size) {
        super(SQLReserved.UROWID.ofExpr());
        this.addArgument(new SQLIntegerLiteral(size));
    }
    ...
    @Override
    public SQLURowIdDataType clone() {
