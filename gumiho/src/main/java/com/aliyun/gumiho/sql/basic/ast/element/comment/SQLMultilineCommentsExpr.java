 ...
 */
public class SQLMultilineCommentsExpr extends AbstractSQLObject implements SQLComments {
    ...
    @Override
    public SQLMultilineCommentsExpr clone() {
        SQLMultilineCommentsExpr x = new SQLMultilineCommentsExpr();
        return x;
    }
