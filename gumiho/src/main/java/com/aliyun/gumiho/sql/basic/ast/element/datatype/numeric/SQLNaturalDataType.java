 ...
 */
public class SQLNaturalDataType extends AbstractSQLNumericDataType  implements ISQLPlsIntegerDataType {

    public SQLNaturalDataType() {
        super(SQLReserved.NATURAL.ofExpr());
    }
    ...
    @Override
    public SQLNaturalDataType clone() {
        SQLNaturalDataType x = new SQLNaturalDataType();
        x.name = this.name;
        return x;
    }
}
