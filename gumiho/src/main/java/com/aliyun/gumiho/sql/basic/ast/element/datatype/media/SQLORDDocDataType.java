 ...
 */
public class SQLORDDocDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLORDDocDataType() {
        super(SQLReserved.ORDDoc.ofExpr());
    }

    public SQLORDDocDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.ORDDoc.ofExpr());
    }
