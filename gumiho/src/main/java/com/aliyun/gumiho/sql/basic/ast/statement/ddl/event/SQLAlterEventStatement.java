 ...
 */
public class SQLAlterEventStatement extends AbstractSQLStatement implements SQLAlterStatement {

    public SQLAlterEventStatement(DBType dbType) {
        super(dbType);
    }
    ...
    public SQLObjectType getObjectType() {
        return SQLObjectType.ALTER_EVENT;
    }
}
