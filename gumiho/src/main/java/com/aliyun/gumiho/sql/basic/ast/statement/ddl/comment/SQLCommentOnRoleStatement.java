 ...
 */
public class SQLCommentOnRoleStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnRoleStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnRoleStatement clone() {
        SQLCommentOnRoleStatement x = new SQLCommentOnRoleStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
