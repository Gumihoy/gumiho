 ...
 */
public class OracleSQLPipelinedByUsingClause extends AbstractOracleSQLExpr implements IOracleSQLPipelinedClause {
    ...
    @Override
    public OracleSQLPipelinedByUsingClause clone() {
