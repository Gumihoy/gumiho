 ...
 */
public class SQLAlterTypeAddMethodsAction extends AbstractSQLExpr implements ISQLAlterTypeAction {
    ...
    @Override
    public SQLAlterTypeAddMethodsAction clone() {
    ...
    /**
     * ADD { map_order_function_spec | subprogram_spec }
     */
