 ...
 */
public class SQLAlterTableSpaceStatement extends AbstractSQLStatement implements SQLAlterStatement {

    public SQLAlterTableSpaceStatement(DBType dbType) {
        super(dbType);
    }
    ...
    public SQLObjectType getObjectType() {
        return SQLObjectType.ALTER_TABLESPACE;
    }
