 ...
 */
public class SQLSIAverageColorDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLSIAverageColorDataType() {
        super(SQLReserved.SI_AverageColor.ofExpr());
    }

    public SQLSIAverageColorDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.SI_AverageColor.ofExpr());
    }
