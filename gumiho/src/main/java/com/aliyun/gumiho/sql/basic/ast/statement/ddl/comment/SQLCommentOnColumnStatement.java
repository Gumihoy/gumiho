 ...
 */
public class SQLCommentOnColumnStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnColumnStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnColumnStatement clone() {
        SQLCommentOnColumnStatement x = new SQLCommentOnColumnStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
