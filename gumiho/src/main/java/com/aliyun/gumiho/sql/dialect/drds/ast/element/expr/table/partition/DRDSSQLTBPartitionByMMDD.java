 ...
 */
public class DRDSSQLTBPartitionByMMDD extends AbstractDRDSSQLTBPartitionBy {
    ...
    @Override
    public DRDSSQLTBPartitionByMMDD clone() {
        DRDSSQLTBPartitionByMMDD x = new DRDSSQLTBPartitionByMMDD();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(DRDSSQLTBPartitionByMMDD x) {
        super.cloneTo(x);
