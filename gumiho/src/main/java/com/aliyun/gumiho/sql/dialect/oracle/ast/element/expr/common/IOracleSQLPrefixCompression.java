 ...
 */
public interface IOracleSQLPrefixCompression extends OracleSQLExpr, IOracleSQLIndexCompression, ISQLAlterTableIotAction {
    @Override
    IOracleSQLPrefixCompression clone();
}
