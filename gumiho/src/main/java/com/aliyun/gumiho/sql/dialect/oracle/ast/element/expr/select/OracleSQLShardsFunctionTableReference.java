 ...
 */
public class OracleSQLShardsFunctionTableReference extends AbstractSQLTableReference implements IOracleSQLTableReference {

    protected SQLName name;

    public OracleSQLShardsFunctionTableReference() {
    }

    public OracleSQLShardsFunctionTableReference(SQLName name) {
        setName(name);
    }
