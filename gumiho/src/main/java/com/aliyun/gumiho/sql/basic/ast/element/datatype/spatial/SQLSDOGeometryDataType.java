 ...
 */
public class SQLSDOGeometryDataType extends AbstractSQLSysDataType implements SQLSpatialDataType {

    public SQLSDOGeometryDataType() {
        super(SQLReserved.SDO_Geometry.ofExpr());
    }

    public SQLSDOGeometryDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.SDO_Geometry.ofExpr());
    }
