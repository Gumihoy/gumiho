 ...
 */
public class SQLCommentOnDatabaseStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnDatabaseStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnDatabaseStatement clone() {
        SQLCommentOnDatabaseStatement x = new SQLCommentOnDatabaseStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
