 ...
 */
public class SQLORDImageDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLORDImageDataType() {
        super(SQLReserved.ORDImage.ofExpr());
    }

    public SQLORDImageDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.ORDImage.ofExpr());
    }
