 ...
 */
public class SQLSDOGeoRasterDataType extends AbstractSQLSysDataType implements SQLSpatialDataType {

    public SQLSDOGeoRasterDataType() {
        super(SQLReserved.SDO_GeoRaster.ofExpr());
    }

    public SQLSDOGeoRasterDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.SDO_GeoRaster.ofExpr());
    }
