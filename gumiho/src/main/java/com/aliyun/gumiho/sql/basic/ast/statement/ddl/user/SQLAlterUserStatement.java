 ...
 */
public class SQLAlterUserStatement extends AbstractSQLStatement implements SQLAlterStatement {

    public SQLAlterUserStatement(DBType dbType) {
        super(dbType);
    }
    ...
    public SQLObjectType getObjectType() {
        return SQLObjectType.ALTER_USER;
    }
}
