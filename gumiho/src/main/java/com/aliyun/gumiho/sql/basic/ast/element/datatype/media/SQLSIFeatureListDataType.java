 ...
 */
public class SQLSIFeatureListDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLSIFeatureListDataType() {
        super(SQLReserved.SI_FeatureList.ofExpr());
    }

    public SQLSIFeatureListDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.SI_FeatureList.ofExpr());
    }
