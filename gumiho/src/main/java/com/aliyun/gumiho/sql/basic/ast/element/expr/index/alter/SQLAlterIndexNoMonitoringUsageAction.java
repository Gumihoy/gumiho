 ...
 */
public class SQLAlterIndexNoMonitoringUsageAction extends AbstractSQLExpr implements ISQLAlterIndexAction {
    ...
    @Override
    public SQLAlterIndexNoMonitoringUsageAction clone() {
