 ...
 */
public class SQLAutoIncrementColumnConstraint extends AbstractSQLConstraint implements ISQLColumnConstraint {
    ...
    @Override
    public SQLAutoIncrementColumnConstraint clone() {
        SQLAutoIncrementColumnConstraint x = new SQLAutoIncrementColumnConstraint();
        return x;
    }
}
