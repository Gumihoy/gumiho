 ...
 */
public class SQLORDDicomDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLORDDicomDataType() {
        super(SQLReserved.ORDDicom.ofExpr());
    }

    public SQLORDDicomDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.ORDDicom.ofExpr());
    }
