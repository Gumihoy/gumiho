 ...
 */
public class SQLCommentOnOperatorStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnOperatorStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnOperatorStatement clone() {
        SQLCommentOnOperatorStatement x = new SQLCommentOnOperatorStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
}
