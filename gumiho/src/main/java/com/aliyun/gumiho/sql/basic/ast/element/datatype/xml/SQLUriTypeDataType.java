 ...
 */
package com.aliyun.gumiho.sql.basic.ast.element.datatype.xml;
 ...
 */
public class SQLUriTypeDataType extends AbstractSQLSysDataType implements SQLXmlDataType {

    public SQLUriTypeDataType() {
        super(SQLReserved.URIType.ofExpr());
    }

    public SQLUriTypeDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.URIType.ofExpr());
    }
