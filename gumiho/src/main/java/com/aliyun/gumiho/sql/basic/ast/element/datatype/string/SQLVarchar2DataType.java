...
import com.aliyun.gumiho.sql.basic.ast.enums.SQLCharSizeUnit;
 ...
 */
public class SQLVarchar2DataType extends AbstractSQLTextDataType {

    protected SQLCharSizeUnit charSizeUnit;

    public SQLVarchar2DataType() {
        super(SQLReserved.VARCHAR2.ofExpr());
    }
    ...
    public SQLCharSizeUnit getCharSizeUnit() {
        return charSizeUnit;
    }

    public void setCharSizeUnit(SQLCharSizeUnit charSizeUnit) {
