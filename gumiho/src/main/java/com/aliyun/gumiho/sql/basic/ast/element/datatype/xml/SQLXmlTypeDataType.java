 ...
 */
public class SQLXmlTypeDataType extends AbstractSQLSysDataType implements SQLXmlDataType {

    public SQLXmlTypeDataType() {
        super(SQLReserved.XMLType.ofExpr());
    }

    public SQLXmlTypeDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.XMLType.ofExpr());
    }
