 ...
 */
public class SQLCheckPartitionDefinition extends AbstractSQLExpr implements ISQLAlterTableAction {
    ...
    @Override
    public SQLCheckPartitionDefinition clone() {
        SQLCheckPartitionDefinition x = new SQLCheckPartitionDefinition();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLCheckPartitionDefinition x) {
        super.cloneTo(x);
