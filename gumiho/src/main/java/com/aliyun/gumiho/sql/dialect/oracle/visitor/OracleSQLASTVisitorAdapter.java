 ...
 */
public class OracleSQLASTVisitorAdapter extends SQLASTVisitorAdapter implements OracleSQLASTVisitor {

    public OracleSQLASTVisitorAdapter() {
    }

    public OracleSQLASTVisitorAdapter(SQLTransformConfig config) {
        super(config);
    }
