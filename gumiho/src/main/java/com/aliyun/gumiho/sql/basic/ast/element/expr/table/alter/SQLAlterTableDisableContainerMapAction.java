 ...
 */
public class SQLAlterTableDisableContainerMapAction extends AbstractSQLExpr implements ISQLAlterTableAction {
    ...
    @Override
    public SQLAlterTableDisableContainerMapAction clone() {
