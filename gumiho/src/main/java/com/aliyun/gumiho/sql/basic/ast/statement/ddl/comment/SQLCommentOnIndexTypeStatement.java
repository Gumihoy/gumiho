 ...
 */
public class SQLCommentOnIndexTypeStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnIndexTypeStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnIndexTypeStatement clone() {
        SQLCommentOnIndexTypeStatement x = new SQLCommentOnIndexTypeStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
