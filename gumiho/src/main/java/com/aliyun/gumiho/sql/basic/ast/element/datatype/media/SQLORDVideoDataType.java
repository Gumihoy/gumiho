 ...
 */
public class SQLORDVideoDataType extends AbstractSQLSysDataType implements SQLMediaDataType {

    public SQLORDVideoDataType() {
        super(SQLReserved.ORDVideo.ofExpr());
    }

    public SQLORDVideoDataType(boolean sysOwner) {
        super(sysOwner, SQLReserved.ORDVideo.ofExpr());
    }
