 ...
 */
public class SQLSimpleDoubleDataType extends AbstractSQLNumericDataType {

    public SQLSimpleDoubleDataType() {
        super(SQLReserved.SIMPLE_DOUBLE.ofExpr());
    }
    ...
    @Override
    public SQLSimpleDoubleDataType clone() {
        SQLSimpleDoubleDataType x = new SQLSimpleDoubleDataType();
        x.name = this.name;
        return x;
    }
}
