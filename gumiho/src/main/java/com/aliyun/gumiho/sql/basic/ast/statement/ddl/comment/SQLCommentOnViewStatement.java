 ...
 */
public class SQLCommentOnViewStatement extends AbstractSQLCommentStatement {


    public SQLCommentOnViewStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnViewStatement clone() {
        SQLCommentOnViewStatement x = new SQLCommentOnViewStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
