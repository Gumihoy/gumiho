 ...
 */
public class SQLAlterTableModifyPartitionForAction extends AbstractSQLAlterTableModifyPartitionAction {
    ...
    @Override
    public SQLAlterTableModifyPartitionForAction clone() {
