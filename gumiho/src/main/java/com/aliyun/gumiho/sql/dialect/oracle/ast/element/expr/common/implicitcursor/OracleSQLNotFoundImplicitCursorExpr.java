 ...
 */
public class OracleSQLNotFoundImplicitCursorExpr extends AbstractOracleSQLExpr implements IOracleSQLImplicitCursorExpr {
    ...
    @Override
    public OracleSQLNotFoundImplicitCursorExpr clone() {
        OracleSQLNotFoundImplicitCursorExpr x = new OracleSQLNotFoundImplicitCursorExpr();
        return x;
    }
}
