 ...
 */
public class SQLCommentOnTablespaceStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnTablespaceStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnTablespaceStatement clone() {
        SQLCommentOnTablespaceStatement x = new SQLCommentOnTablespaceStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
