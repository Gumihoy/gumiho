 ...
 */
public class SQLCommentOnIndexStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnIndexStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnIndexStatement clone() {
        SQLCommentOnIndexStatement x = new SQLCommentOnIndexStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
