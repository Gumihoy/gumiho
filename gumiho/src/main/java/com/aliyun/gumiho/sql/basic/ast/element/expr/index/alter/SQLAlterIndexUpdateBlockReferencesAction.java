 ...
 */
public class SQLAlterIndexUpdateBlockReferencesAction extends AbstractSQLExpr implements ISQLAlterIndexAction {
    ...
    @Override
    public SQLAlterIndexUpdateBlockReferencesAction clone() {
