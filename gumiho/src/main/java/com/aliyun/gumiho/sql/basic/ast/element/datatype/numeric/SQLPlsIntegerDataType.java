 ...
 */
public class SQLPlsIntegerDataType extends AbstractSQLNumericDataType {

    public SQLPlsIntegerDataType() {
        super(SQLReserved.PLS_INTEGER.ofExpr());
    }
    ...
    @Override
    public SQLPlsIntegerDataType clone() {
        SQLPlsIntegerDataType x = new SQLPlsIntegerDataType();
        x.name = this.name;
        return x;
    }
}
