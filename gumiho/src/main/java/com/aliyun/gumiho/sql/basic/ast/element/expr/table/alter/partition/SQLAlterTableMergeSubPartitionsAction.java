 ...
 */
public class SQLAlterTableMergeSubPartitionsAction extends AbstractSQLAlterTableMergeSubPartitionsAction implements ISQLAlterTableAction {
    ...
    @Override
    public SQLAlterTableMergeSubPartitionsAction clone() {
        SQLAlterTableMergeSubPartitionsAction x = new SQLAlterTableMergeSubPartitionsAction();
        this.cloneTo(x);
        return x;
    }

    public void cloneTo(SQLAlterTableMergeSubPartitionsAction x) {
        super.cloneTo(x);
