 ...
 */
public class OracleSQLExtentManagementLocalUniformClause extends AbstractOracleSQLExpr implements OracleSQLExtentManagementClause {

    public OracleSQLSizeClause size;


    public OracleSQLExtentManagementLocalUniformClause() {
    }
