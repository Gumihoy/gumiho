 ...
 */
public class SQLCommentOnServerStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnServerStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnServerStatement clone(){
        SQLCommentOnServerStatement x = new SQLCommentOnServerStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
