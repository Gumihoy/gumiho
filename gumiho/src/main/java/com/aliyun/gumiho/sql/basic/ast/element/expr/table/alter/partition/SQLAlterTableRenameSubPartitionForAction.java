...
/**
 * RENAME SUBPARTITION FOR (name [,name]... )  TO new_name
 * <p>
 ...
 */
public class SQLAlterTableRenameSubPartitionForAction extends AbstractSQLAlterTableRenamePartitionAction {
    ...
    @Override
    public SQLAlterTableRenameSubPartitionForAction clone() {
