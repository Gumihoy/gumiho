 ...
 */
public class SQLCommentOnSequenceStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnSequenceStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnSequenceStatement clone() {
        SQLCommentOnSequenceStatement x = new SQLCommentOnSequenceStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
