 ...
 */
public class SQLPositiveDataType extends AbstractSQLNumericDataType  implements ISQLPlsIntegerDataType {

    public SQLPositiveDataType() {
        super(SQLReserved.POSITIVE.ofExpr());
    }
    ...
    @Override
    public SQLPositiveDataType clone() {
        SQLPositiveDataType x = new SQLPositiveDataType();
        x.name = this.name;
        return x;
    }
}
