 ...
 */
public class SQLCommentOnTypeStatement extends AbstractSQLCommentStatement {

    public SQLCommentOnTypeStatement(DBType dbType) {
        super(dbType);
    }
    ...
    @Override
    public SQLCommentOnTypeStatement clone() {
        SQLCommentOnTypeStatement x = new SQLCommentOnTypeStatement(this.dbType);
        this.cloneTo(x);
        return x;
    }
