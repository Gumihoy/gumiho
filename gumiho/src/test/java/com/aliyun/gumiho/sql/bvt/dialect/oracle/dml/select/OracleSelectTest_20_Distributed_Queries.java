 ...
 */
public class OracleSelectTest_20_Distributed_Queries {
    ...
    public void test1() {
        ...
        Assert.assertEquals("SELECT last_name, department_name\n" +
                "FROM employees@remote, departments\n" +
                "WHERE employees.department_id = departments.department_id;", format);
    }
