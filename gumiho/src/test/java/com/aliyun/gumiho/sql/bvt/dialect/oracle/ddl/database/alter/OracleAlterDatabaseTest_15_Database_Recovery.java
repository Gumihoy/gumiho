 ...
 */
public class OracleAlterDatabaseTest_15_Database_Recovery {
...
//                "  RECOVER AUTOMATIC DATABASE;", formatSQL);
    }
    ...
    public void test_1() {
        ...
        System.out.println(formatSQL);
//        Assert.assertEquals("ALTER DATABASE \n" +
//                "    RECOVER LOGFILE 'diskc:log3.log';", formatSQL);
    }
    ...
    public void test_2() {
        ...
        System.out.println(formatSQL);
//        Assert.assertEquals("ALTER DATABASE \n" +
//                "    RECOVER AUTOMATIC UNTIL TIME '2001-10-27:14:00:00';", formatSQL);
    }
}
