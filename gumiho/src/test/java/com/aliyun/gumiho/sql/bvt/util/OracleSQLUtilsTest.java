 ...
 */
public class OracleSQLUtilsTest {


    @Test
    public void testToSQLString() {
        SQLOrderByClause orderByClause = new SQLOrderByClause();
        SQLOrderByItem orderByItem = new SQLOrderByItem("\"afa\"");
        orderByClause.addItem(orderByItem);
        System.out.println(OracleUtils.toSQLString(orderByClause));
    }
}
