 ...
 */
public class Oracle2DRDSCreateTableTest_11_Rename_Table_Column {
    ...
    public void test_0() {
        ...
        SQLTransformConfig.ColumnMapping columnMapping1 = new SQLTransformConfig.ColumnMapping("FTPID", "FTPID1");

        SQLTransformConfig.ColumnMapping columnMapping2 = new SQLTransformConfig.ColumnMapping("OPERATEDATE", "OPERATEDATE1");

        SQLTransformConfig.TableMapping tableMapping = new SQLTransformConfig.TableMapping("U3C_MG_BRANCHUPLOG", "U3C_MG_BRANCHUPLOG", columnMapping1, columnMapping2);
