...
public class OracleSQLToCharFunctionTest {
    ...
    public void test_1() {
        ...
        Assert.assertEquals("SELECT TO_CHAR(ts_col, 'DD-MON-YYYY HH24:MI:SSxFF') AS ts_date,\n" +
                "\tTO_CHAR(tstz_col, 'DD-MON-YYYY HH24:MI:SSxFF TZH:TZM') AS tstz_date\n" +
                "FROM date_tab\n" +
                "ORDER BY ts_date, tstz_date;", format);
    }
    ...
    public void test_2() {
        ...
        System.out.println("----------------");
        System.out.println(format);
        Assert.assertEquals("SELECT TO_CHAR(INTERVAL '123-2' YEAR(3) TO MONTH)\n" +
                "FROM DUAL;", format);
    }
