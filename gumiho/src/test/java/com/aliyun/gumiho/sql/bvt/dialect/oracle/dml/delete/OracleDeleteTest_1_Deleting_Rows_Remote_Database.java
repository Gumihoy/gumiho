 ...
 */
public class OracleDeleteTest_1_Deleting_Rows_Remote_Database {
    ...
    @Test
    public void test2() {
        String sql = "DELETE FROM af.hr.locations@remote.remote\n" +
                "   WHERE location_id > 3000;";
        String format = SQLUtils.format(sql, DBType.Oracle);
        System.out.println(sql);
        System.out.println("----------------------");
        System.out.println(format);
        Assert.assertEquals("DELETE FROM af.hr.locations@remote.remote\n" +
                "WHERE location_id > 3000;", format);
    }
}
