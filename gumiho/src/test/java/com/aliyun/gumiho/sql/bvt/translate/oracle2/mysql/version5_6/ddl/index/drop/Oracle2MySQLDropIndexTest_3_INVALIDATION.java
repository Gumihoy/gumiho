package com.aliyun.gumiho.sql.bvt.translate.oracle2.mysql.version5_6.ddl.index.drop;
 ...
 */
public class Oracle2MySQLDropIndexTest_3_INVALIDATION {

    @Test
    public void test() {
        String sql = "CREATE INDEX ord_customer_ix ON orders (customer_id); DROP INDEX ord_customer_ix IMMEDIATE INVALIDATION;";
