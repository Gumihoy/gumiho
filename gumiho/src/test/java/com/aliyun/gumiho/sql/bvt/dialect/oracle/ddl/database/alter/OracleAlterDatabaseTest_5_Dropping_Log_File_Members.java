 ...
 */
public class OracleAlterDatabaseTest_5_Dropping_Log_File_Members {
...
//                "    DROP LOGFILE MEMBER 'diskb:log3.log';", formatSQL);
    }
    ...
    public void test_1() {
        ...
        System.out.println("------------------");
        System.out.println(formatSQL);
//        Assert.assertEquals("ALTER DATABASE DROP LOGFILE GROUP 3;", formatSQL);
    }
}
