 ...
 */
package com.aliyun.gumiho.sql.bvt.translate.oracle2.postgresql.version9_6.dml.insert;
 ...
 */
public class OracleInsertTest_1_alias {

    @Test
    public void test1() {
        String sql = "insert into \"dual\" \"s\" (s.\"id\", s.\"name\") values (1, '1'), (2, '2')";
        ...
        Assert.assertEquals("INSERT INTO dual s (id, name)\n" +
                "VALUES (1, '1'),\n" +
