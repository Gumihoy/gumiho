 ...
 */
public class OracleAlterIndexTest_6_Rebuild_Partition {

    @Test
    public void test_0() {
        String s = "ALTER INDEX cost_ix \n" +
        ...
        Assert.assertEquals("ALTER INDEX cost_ix\n" +
                "\tREBUILD PARTITION p2;", formatSQL);
    }
    ...
    public void test_1() {
        ...
        System.out.println(formatSQL);
        Assert.assertEquals("ALTER INDEX cost_ix\n" +
                "\tREBUILD PARTITION p3 NOLOGGING;", formatSQL);
    }
}
