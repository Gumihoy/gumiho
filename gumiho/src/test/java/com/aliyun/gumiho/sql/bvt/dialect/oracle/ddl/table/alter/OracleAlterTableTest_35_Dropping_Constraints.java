 ...
 */
public class OracleAlterTableTest_35_Dropping_Constraints {

    @Test
    public void test_0() {
        String s = "ALTER TABLE departments \n" +
        ...
        Assert.assertEquals("ALTER TABLE departments\n" +
                "\tDROP PRIMARY KEY CASCADE;", formatSQL);
    }
    ...
    public void test_1() {
        ...
        System.out.println(formatSQL);
        Assert.assertEquals("ALTER TABLE departments\n" +
                "\tDROP CONSTRAINT pk_dept CASCADE;", formatSQL);
    }
