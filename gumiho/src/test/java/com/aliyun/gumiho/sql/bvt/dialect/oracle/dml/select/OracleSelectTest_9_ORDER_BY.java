 ...
 */
public class OracleSelectTest_9_ORDER_BY {
    ...
    public void test1() {
        ...
        Assert.assertEquals("SELECT last_name, department_id, salary\n" +
                "FROM employees\n" +
                "ORDER BY department_id ASC, salary DESC, last_name;", format);
    }
    ...
    public void test2() {
        ...
        Assert.assertEquals("SELECT last_name, department_id, salary\n" +
                "FROM employees\n" +
                "ORDER BY 2 ASC, 3 DESC, 1;", format);
    }
    ...
    public void test3() {
        String sql = "SELECT last_name, department_id, salary \n" +
                "   FROM employees \n" +
                "   ORDER BY to_number(kk), 3 DESC, 1; ";
        String format = SQLUtils.format(sql, DBType.Oracle);
        System.out.println(sql);
        System.out.println("----------------------");
        System.out.println(format);
        Assert.assertEquals("SELECT last_name, department_id, salary\n" +
                "FROM employees\n" +
                "ORDER BY to_number(kk), 3 DESC, 1;", format);
    }
}
