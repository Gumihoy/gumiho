 ...
 */
public class OracleAlterDatabaseTest_12_Enabling_Disabling_Block_Change_Tracking {
...
//                "  ENABLE BLOCK CHANGE TRACKING\n" +
//                "    USING FILE 'tracking_file' REUSE;", formatSQL);
    }
    ...
    public void test_1() {
        ...
        System.out.println(formatSQL);
//        Assert.assertEquals("ALTER DATABASE\n" +
//                "  DISABLE BLOCK CHANGE TRACKING;", formatSQL);
    }
}
