 ...
 */
public class OracleAlterDatabaseTest_1_Read {
...
//        Assert.assertEquals("ALTER DATABASE OPEN READ ONLY;", formatSQL);
    }
    ...
    public void test_1() {
        ...
        System.out.println("------------------");
        System.out.println(formatSQL);
//        Assert.assertEquals("ALTER DATABASE OPEN READ WRITE RESETLOGS;", formatSQL);
    }
}
